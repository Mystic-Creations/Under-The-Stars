package net.lumynity.underthestars;

import dev.architectury.event.events.common.InteractionEvent;
import dev.architectury.event.events.common.PlayerEvent;
import dev.architectury.event.events.common.TickEvent;
import net.lumynity.underthestars.registries.*;
import net.lumynity.underthestars.mechanics.logic.HealingCampfire;
import net.lumynity.underthestars.mechanics.logic.SugarRushInsomnia;
import net.lumynity.underthestars.mechanics.advancement.EasterEggAdvancements;
import net.lumynity.underthestars.mechanics.advancement.StargazingAdvancement;

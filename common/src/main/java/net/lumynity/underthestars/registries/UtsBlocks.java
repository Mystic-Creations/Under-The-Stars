package net.lumynity.underthestars.registries;
...
import net.lumynity.underthestars.content.block.SleepingBag;
import net.lumynity.underthestars.content.block.Smore;
